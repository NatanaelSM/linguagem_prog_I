...
public class TelaPagamento extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(pagamento == null){
            JOptionPane.showMessageDialog(this, "O pagamento não existe!");
        }
        JOptionPane.showMessageDialog(this, pagamento.cancelarPagamento());
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        JOptionPane.showMessageDialog(this, pagamento.exibirDetalhes());
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        JOptionPane.showMessageDialog(this, pagamento.realizarPagamento());
    }//GEN-LAST:event_jButton3ActionPerformed

    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed

        String valor = jTextField1.getText();
        String formaPagamento = jTextField2.getText();
        String parcelas = jTextField3.getText();
