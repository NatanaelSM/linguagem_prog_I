...
public class TelaVestimenta extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(vestimenta == null){
            JOptionPane.showMessageDialog(this, "A vestimenta não existe!");
        }
        JOptionPane.showMessageDialog(this, vestimenta.aumentarPrecos(20));
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        JOptionPane.showMessageDialog(this, vestimenta.getUnidades());
    }//GEN-LAST:event_jButton3ActionPerformed

    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed

        String tipo = jTextField1.getText();
        String unidade = jTextField2.getText();
